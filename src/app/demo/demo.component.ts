...
export class DemoComponent implements OnInit {
  ...
  ngOnInit(): void  {
    ...
    var loaderUrl = buildUrl + "/blueballoon_webgl.loader.js";
    var config = {
      dataUrl: buildUrl + "/blueballoon_webgl.data.br",
      frameworkUrl: buildUrl + "/blueballoon_webgl.framework.js.br",
      codeUrl: buildUrl + "/blueballoon_webgl.wasm.br",
